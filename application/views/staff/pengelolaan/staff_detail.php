                    ...
                    <div class="data-table-list">
                        ...
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <div class="table-responsive">
                                <form action="<?=base_url()?>staff/pengelolaanstaff/ubah" enctype="multipart/form-data" method="post">
                        ...
                        <div id="menu1" class="tab-pane fade">
                            ...
                            <a data-toggle="modal" href="#modalRiwayatPendidikan" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <table class="table table-bordered">
                                <tr>
                                    <th>No</th>
                                ...
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusriwayatpendidikan/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                </tr>
                                <?php }?>
                            </table>
                        </div>
                        ...
                        <div id="menu2" class="tab-pane fade">
                            ...
                            <a data-toggle="modal" href="#modalRiwayatPelatihan" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$rp->jumlah_jam?></td>
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusriwayatpelatihan/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu3" class="tab-pane fade">
                            ...
                            <a data-toggle="modal" href="#modalRiwayatJabatan" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusriwayatjabatan/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu4" class="tab-pane fade">
                            ...
                            <a data-toggle="modal" href="#modalRiwayatTugasTambahan" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$rp->tanggal_sk?></td>
                                        <td><?=$rp->pejabat_pengesah?></td>
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusriwayattugastambahan/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu5" class="tab-pane fade">
                            ...
                            <a data-toggle="modal" href="#modalRiwayatKepangkatan" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br><br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$rp->tanggal_sk?></td>
                                        <td><?=$rp->pejabat_pengesah?></td>
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusriwayatkepangkatan/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu6" class="tab-pane fade">
                            <br>
                            <h3>DATA KELUARGA</h3>
                            <a data-toggle="modal" href="#modalKeluarga" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br><br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$rp->pekerjaan?></td>
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapuskeluarga/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu7" class="tab-pane fade">
                            <br>
                            <h3>DATA ANAK</h3>
                            <a data-toggle="modal" href="#modalAnak" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br><br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusanak/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu8" class="tab-pane fade">
                            ...
                            <a data-toggle="modal" href="#modalOrtu" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br><br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$rp->alamat?></td>
                                        <td><?=$rp->pendidikan_terakhir?></td>
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusortu/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
                        ...
                        <div id="menu9" class="tab-pane fade">
                            <br>
                            <h3>NILAI DP2T</h3>
                            <a data-toggle="modal" href="#modalNilai" class="pull-right btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                            <br><br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$rp->tahun?></td>
                                        <td><?=$rp->nilai?></td>
                                        <td><a onclick="return confirm('hapus data ini?')" href="<?=base_url()?>staff/pengelolaanstaff/hapusnilai/<?=$staff->id?>/<?=$rp->id?>">hapus</a></td>
                                    </tr>
                                    <?php }?>
                                </table>
                            </div>
    ...
    <div class="modal" id="modalRiwayatPendidikan" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpanriwayatpendidikan">
    ...
    <div class="modal" id="modalRiwayatPelatihan" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpanriwayatpelatihan">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
    ...
    <div class="modal" id="modalRiwayatJabatan" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpanriwayatjabatan">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
                    <h2>Form Riwayat Pelatihan</h2>
                    <div class="form-group">
    ...
    <div class="modal" id="modalRiwayatTugasTambahan" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpanriwayattugastambahan">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
    ...
    <div class="modal" id="modalRiwayatKepangkatan" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpanriwayatkepangkatan">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
    ...
    <div class="modal" id="modalKeluarga" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpankeluarga">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
    ...
    <div class="modal" id="modalAnak" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpananak">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
    ...
    <div class="modal" id="modalOrtu" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpanortu">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
    ...
    <div class="modal" id="modalNilai" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form method="post" action="<?=base_url()?>staff/pengelolaanstaff/simpannilai">
                <input type="hidden" name="staff_id" value="<?=$staff->id?>">
                <div class="modal-body">
