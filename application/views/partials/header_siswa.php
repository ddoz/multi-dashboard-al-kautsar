...
<head>
    ...
    <title>Multi Dashboard Monitoring Siswa | Al-Kautsar</title>
...
<body>
    ...
    <?php $this->load->view('partials/top_siswa');?>
    <!-- End Header Top Area -->

    <!-- Mobile Menu start -->
    <?php $this->load->view('partials/menu_mobile_siswa'); ?>
    <!-- Mobile Menu end -->

    <!-- Main Menu area start-->
    <?php $this->load->view("partials/menu_main_siswa"); ?>
    <!-- Main Menu area End-->
