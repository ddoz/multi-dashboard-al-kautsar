                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Data Ruangan (Gedung <?=$gedung->nama_gedung?>)</h2>
                            <p>Berikut merupakan data ruangan.</p>
                            <?php if(isSuper()) { ?>
    ...
    <div class="modal" id="modalForm" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="form" action="<?=base_url()?>dma/pengelolaangedung/simpanruangan" enctype="multipart/form-data">
    ...
    <div class="modal" id="modalHapus" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="formHapus" action="<?=base_url()?>dma/pengelolaangedung/hapusruangan">
                <div class="modal-body">
