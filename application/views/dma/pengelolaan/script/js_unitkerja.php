...
$(document).ready(function() {
    $(".btnmodalForm").click(function(e) {
        ...
        $("#form").attr("action","<?=base_url()?>dma/pengelolaanunitkerja/simpan");
    });
...
function edit(data) {
    ...
    $("#form").attr("action","<?=base_url()?>dma/pengelolaanunitkerja/ubah");
}
   ...
   var t =	$('#datatable').DataTable({
        initComplete: function() {
            ...
            serverSide 		: true,
			ajax:{
				url 		: "<?=base_url()?>dma/pengelolaanunitkerja/datatable",
				type 		: "POST"
			},
			columns 		:[
                {data: 'nama_unit'},
