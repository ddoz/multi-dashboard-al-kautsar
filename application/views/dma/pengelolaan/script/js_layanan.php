...
$(document).ready(function() {
    $(".btnmodalForm").click(function(e) {
        ...
        $("#form").attr("action","<?=base_url()?>dma/pengelolaanlayanan/simpan");
    });
...
function edit(data) {
    ...
    $("#form").attr("action","<?=base_url()?>dma/pengelolaanlayanan/ubah");
}
   ...
   var t =	$('#datatable').DataTable({
        initComplete: function() {
            ...
            serverSide 		: true,
			ajax:{
				url 		: "<?=base_url()?>dma/pengelolaanlayanan/datatableLayanan",
				type 		: "POST"
			},
			columns 		:[
                {data: 'nama_layanan'},
