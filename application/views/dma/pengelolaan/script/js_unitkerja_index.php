...
$(document).ready(function() {
    $(".btnmodalForm").click(function(e) {
        ...
        $("#form").attr("action","<?=base_url()?>setting/kelolaunitkerja/simpan");
    });
...
function edit(data) {
    ...
    $("#form").attr("action","<?=base_url()?>setting/kelolaunitkerja/ubah");
}
   ...
   var t =	$('#datatable').DataTable({
        initComplete: function() {
            ...
            serverSide 		: true,
			ajax:{
				url 		: "<?=base_url()?>setting/kelolaunitkerja/datatable",
				type 		: "POST"
			},
			columns 		:[
                {data: 'nama_unit'},
