...
$(document).ready(function() {
    $(".btnmodalForm").click(function(e) {
        ...
        $("#form").attr("action","<?=base_url()?>dma/pengelolaanteknisi/simpan");
    });
...
function edit(data) {
    ...
    $("#form").attr("action","<?=base_url()?>dma/pengelolaanteknisi/ubah");
}
   ...
   var t =	$('#datatable').DataTable({
        initComplete: function() {
            ...
            serverSide 		: true,
			ajax:{
				url 		: "<?=base_url()?>dma/pengelolaanteknisi/datatable",
				type 		: "POST"
			},
			columns 		:[
                {data: 'nama_teknisi'},
