...
$(document).ready(function() {
    $(".btnmodalForm").click(function(e) {
        ...
        $("#form").attr("action","<?=base_url()?>dma/kelolagedung/simpanruangan");
    });
...
function edit(data) {
    ...
    $("#form").attr("action","<?=base_url()?>dma/kelolagedung/ubahruangan");
}
   ...
   var t =	$('#datatable').DataTable({
        initComplete: function() {
            ...
            serverSide 		: true,
			ajax:{
				url 		: "<?=base_url()?>dma/kelolagedung/datatableRuangan/<?=$gedung->id?>",
				type 		: "POST"
			},
			columns 		:[
                {data: 'nama_ruangan'},
