        ...
        <div class="fade-in">
            ...
            <div class="col-md-12">
                ...
                <div class="card-header"><svg class="c-icon">
                    ...
                    </svg>&nbsp;Pengelolaan Data Ruangan (Gedung <?=$gedung->nama_gedung?>)</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
...
<div class="modal" id="modalForm" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="form" action="<?=base_url()?>dma/kelolagedung/simpanruangan" enctype="multipart/form-data">
    ...
    <div class="modal" id="modalHapus" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="formHapus" action="<?=base_url()?>dma/kelolagedung/hapusruangan">
                <div class="modal-body">
