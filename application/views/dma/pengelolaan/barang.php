                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    ...
                                    <p>Selamat datang, <span class="bread-ntd">ini halaman pengelolaan data barang</span></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Data Barang</h2>
                            <p>Berikut merupakan data barang keseluruhan.</p>
    ...
    <div class="modal" id="modalForm" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="form" action="<?=base_url()?>barang/pengelolaanbarang/simpan" enctype="multipart/form-data">
    ...
    <div class="modal" id="modalHapus" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="formHapus" action="<?=base_url()?>dma/pengelolaanbarang/hapus">
                <div class="modal-body">
