    ...
    <div class="modal" id="modalForm" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="form" action="<?=base_url()?>setting/kelolauser/simpan" enctype="multipart/form-data">
    ...
    <div class="modal" id="modalHapus" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                ...
                <form id="formHapus" action="<?=base_url()?>setting/kelolauser/hapus">
                <div class="modal-body">
