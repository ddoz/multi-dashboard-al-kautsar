...
class Kelolagedung extends CI_Controller {
	...
	{
        $data['content'] = 'dma/pengelolaan/gedung_index';
        $data['menu'] = 'pengelolaan';
        $data['script'] = 'dma/pengelolaan/script/js_gedung_index';
        $data['app'] = getAppList();
		...
		$data['form'] = array(
          ...
          $data['breadcumb'] = buildBreadcumb(array('App','SIDMA','Pengelolaan Gedung'));
    ...
    public function datatableGedung(){
        ...
        $this->datatables->add_column('action',function($row){
            if(isSuper()) {
                ...
                $button .= "<a href='".base_url()."dma/kelolagedung/ruangan/".$row['id']."' class='btn btn-info btn-sm'>Ruangan</a>";
    ...
    public function ruangan() {
        ...
        $data['content'] = 'dma/pengelolaan/ruangan_index';
        $data['menu'] = 'pengelolaan';
        $data['script'] = 'dma/pengelolaan/script/js_ruangan_index';
		...
		$data['form'] = array(
          ...
          $data['breadcumb'] = buildBreadcumb(array('App','SIDMA','Pengelolaan Gedung',"Ruangan"));
          // $this->load->view('partials/wrapper_dma',$data);
          buildPage($data);
    }
