...
class Kelolalayanan extends CI_Controller {
	...
	{
        $data['content'] = 'dma/pengelolaan/layanan_index';
        $data['menu'] = 'pengelolaan';
        $data['script'] = 'dma/pengelolaan/script/js_layanan_index';
        $data['app'] = getAppList();
		...
		$data['form'] = array(
          ...
          $data['breadcumb'] = buildBreadcumb(array('App','SIDMA','Pengelolaan Layanan'));
