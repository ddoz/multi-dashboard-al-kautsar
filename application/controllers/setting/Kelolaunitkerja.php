...
class Kelolaunitkerja extends CI_Controller {
	...
	{
        $data['content'] = 'setting/unitkerja_index';
        $data['menu'] = 'pengelolaan';
        $data['script'] = 'setting/script/js_unitkerja_index';
        $data['app'] = getAppList();
		...
		$data['form'] = array(
          ...
          $data['breadcumb'] = buildBreadcumb(array('App','Setting','Pengelolaan Unit Kerja'));
